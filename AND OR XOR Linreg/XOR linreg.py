...
experiment = mlflow.set_experiment("XOR linreg FINAL")
mlflow.set_experiment_tag("XOR linreg FINAL", 1)
...
if __name__ == "__main__":
    ...
    with mlflow.start_run(run_name="good run"):
        ...
        print("  MAE: %s" % mae)
        print("  R2: %s" % r2)
        # логаем расчитанные вручную метрики с помощью mlflow
        ...
        if tracking_url_type_store != "file":
            ...
            mlflow.sklearn.log_model(
                lr, "model", registered_model_name="ElasticnetXOR", signature=signature
            )
        else:
